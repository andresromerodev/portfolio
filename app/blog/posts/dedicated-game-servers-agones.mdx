---
title: 'Dedicated Game Server Hosting on Kubernetes with Agones'
publishedAt: '2024-08-08'
summary: 'Deploy multiplayer games on Kubernetes using Agones for scalable dedicated server hosting.'
---

In this post, I’ll demonstrate how to deploy a multiplayer game on Agones using Kubernetes. Feel free to jump to the hands-on section if you want to skip the theory and understand why I'm writing this post. Otherwise, feel free to continue reading from here!
...
In the game development realm, one standout open source tool is particularly noteworthy: Agones. It's not only prominent but also battle-tested. Agones is described as "an open source, batteries-included, multiplayer dedicated game server scaling and orchestration platform that runs on Kubernetes." In this post, I'll demonstrate how you can harness Agones to host your multiplayer game.
...
You can find the repository here: [https://github.com/andresromerodev/godot-agones-multiplayer](https://github.com/andresromerodev/godot-agones-multiplayer). Feel free to download and run it using Godot!
